...
public class BuildingMaster : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        List<string> RareMaterials = new List<string>() { "iron", "nickel", "iridium", "palladium", "platinum", "gold", "magnesium" };
        foreach (string mat in this.GetComponent<PlanetProperties>().RareMaterials)
        {
    ...
    public void AddHomeStockpile(string MaterialName, double MaterialAmount)
    {
        ...
        HomeStockpile[MaterialName] += MaterialAmount;
    }
    ...
    public void clickToPlanet()
    {
        ...
        {
            GameObject.Find("TextStockpile").GetComponent<TMP_Text>().text = "local stockpile";
        }
        else
        {
