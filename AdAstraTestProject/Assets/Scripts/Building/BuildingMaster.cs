...
public class BuildingMaster : MonoBehaviour
{
    ...
    public List<string> lvl2Buildings = new List<string>() { "Apartments,100,200,0,0,200", "Surface Mining,500,500,100,0,200", "Warehouses,500,500,0,0,200" }; //mining of rare materials and stockpileing it also more income
